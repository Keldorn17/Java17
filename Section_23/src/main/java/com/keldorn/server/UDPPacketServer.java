...
public class UDPPacketServer {
    ...
    public static void main(String[] args) {
        try (DatagramSocket serverSocket = new DatagramSocket(PORT)) {
            ...
            try {
                File audioFile = new File(RESOURCES_PATH + audioFileName);
    ...
    private static void sendDataToClient(String file, DatagramSocket serverSocket, DatagramPacket clientPacket) {
        ...
        try (FileChannel fileChannel = FileChannel.open(Paths.get(RESOURCES_PATH + file), StandardOpenOption.READ)) {
